...
# print(f"Pizza Base: {pizza_base} inches, Topping {topping}")
# print(f"Is Extra Cheese required: {topping}")
...
# Pizza Base: {pizza_base}, {pizza_size} inches, with {topping}.
# Is Extra Cheese required: {extra_cheese}.
# Total Bill Amount: ${price}.
# """
